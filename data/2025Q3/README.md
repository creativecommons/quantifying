# Quantifying the Commons 2025Q3
...
**The results indicate there are a total of 29,077,032,773 online works in the commons--documents that are licensed or put in the public domain using a Creative Commons (CC) legal tool.**
...
The complete data set indicates there are a total of 1,818,599,693 online works using a latest CC legal tool.
...
The complete data set indicates there are a total of 986,846,413 online works using a latest CC legal tool.
