...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Met Museum Reports")
    parser.add_argument(
        "--quarter",
        "-q",
        type=str,
...
def visualize_by_license_type(data, args):
    ...
    plt.title("Number of MetMuseum Documents by License Type")
    ...
    image_path = os.path.join(output_directory, "metmuseum_license_report.png")
    ...
    shared.update_readme(
        ...
        image_path,
        "MetMuseum",
        "Number of MetMuseum Documents by License Type",
        "License Type Report",
        args,
    )
