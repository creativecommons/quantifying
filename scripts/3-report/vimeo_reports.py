...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Vimeo Data Report")
    parser.add_argument(
        "--quarter",
        "-q",
        type=str,
...
def load_data(args):
    ...
    file_path = os.path.join(
        PATHS["data"], f"{selected_quarter}", "1-fetch", "vimeo_fetched.csv"
    )
...
def visualize_by_license_type(data, args):
    """
    Create a bar chart for the number of documents by license type.
    """
    LOGGER.info(
    ...
    plt.title("Number of Vimeo Documents by License Type")
    ...
    image_path = os.path.join(output_directory, "vimeo_license_report.png")
    ...
    shared.update_readme(
        ...
        image_path,
        "Vimeo",
        "Number of Vimeo Documents by License Type",
        "License Type Report",
        args,
    )
